    ...
    <>
      ...
      >
        <div className="flex flex-col justify-center items-center relative z-10 text-center">
          ...
          <TextGenerateEffect
            words="Junior Backend developer & Devops Specialist"
          ...
          <p className="pt-5 pb-8 text-sm sm:text-base md:text-lg text-dark-200 dark:text-stone-200/70">
            Hi, I&apos;m Idan Koblik, freelancer junior Backend developer and DevOps Specialist.
          </p>
          <div className="flex flex-col sm:flex-row items-center gap-4">
            ...
            <a
              href="https://docs.google.com/document/d/e/2PACX-1vQWO1Lz33Jp--3LJRZNb_DI9zSvV925inStOGo1cZ0ljubGjJejDW7SuJiyU12pMmzXEfel9l6_ALm1/pub"
              download
